...
object Versions {
    ...
    const val WALTID_VERSION = "0.6.0"
}
...
dependencies {
    ...
    implementation("id.walt:waltid-verifier-api:${Versions.WALTID_VERSION}")
    implementation("id.walt:waltid-issuer-api:${Versions.WALTID_VERSION}")
    implementation("id.walt.reporting:waltid-reporting:${Versions.WALTID_VERSION}")
