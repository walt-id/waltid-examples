...
suspend fun export_jwk_object() {
    println("Generating key: RSA")
    val key = LocalKey.generate(KeyType.RSA)
    println("Key id: " + key.getKeyId())
    println("Exporting JWKObject...")
    val exportedJwk = key.exportJWKObject()
    ...
    println("Exporting JWKObject...")
    val exportedJwk1 = key1.exportJWKObject()
    ...
    println("Exporting JWKObject...")
    val exportedJwk2 = key2.exportJWKObject()
    ...
    println("Exporting JWKObject...")
    val exportedJwk3 = key3.exportJWKObject()
